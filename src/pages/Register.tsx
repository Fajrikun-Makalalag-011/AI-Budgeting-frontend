...
const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      else setError("Registrasi gagal");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-400 via-purple-400 to-pink-300 transition-all duration-500">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full bg-gradient-to-r from-green-600 to-blue-600 text-white py-3 rounded-lg font-bold text-lg shadow-md hover:scale-[1.03] hover:shadow-xl transition-all duration-200 disabled:opacity-60"
          disabled={loading}
        >
